...
// End Cross Module References
	...
	{
		P_GET_OBJECT(UInventory,Z_Param_CInventory);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->ShowContainer(Z_Param_CInventory);
		P_NATIVE_END;
	}
	...
	struct Z_Construct_UFunction_UPlayerHud_ShowContainer_Statics
	{
		...
		{
			UInventory* CInventory;
		};
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_CInventory_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_CInventory;
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPlayerHud_ShowContainer_Statics::NewProp_CInventory_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UPlayerHud_ShowContainer_Statics::NewProp_CInventory = { "CInventory", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(PlayerHud_eventShowContainer_Parms, CInventory), Z_Construct_UClass_UInventory_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UPlayerHud_ShowContainer_Statics::NewProp_CInventory_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UPlayerHud_ShowContainer_Statics::NewProp_CInventory_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPlayerHud_ShowContainer_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPlayerHud_ShowContainer_Statics::NewProp_CInventory,
	};
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPlayerHud_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UPlayerHud_ShowContainer, "ShowContainer" }, // 3627465131
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_Automafarm_5_2_Source_Automafarm_Public_UI_PlayerHud_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPlayerHud, UPlayerHud::StaticClass, TEXT("UPlayerHud"), &Z_Registration_Info_UClass_UPlayerHud, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlayerHud), 1279795976U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_Automafarm_5_2_Source_Automafarm_Public_UI_PlayerHud_h_1804527988(TEXT("/Script/Automafarm"),
