...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USlotPreview_Init_Statics::NewProp_InSlotStruct = { "InSlotStruct", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SlotPreview_eventInit_Parms, InSlotStruct), Z_Construct_UScriptStruct_FSlotStruct, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USlotPreview_Init_Statics::NewProp_InSlotStruct_MetaData), Z_Construct_UFunction_USlotPreview_Init_Statics::NewProp_InSlotStruct_MetaData) }; // 3392258304
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USlotPreview_Init_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USlotPreview, nullptr, "Init", nullptr, nullptr, Z_Construct_UFunction_USlotPreview_Init_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USlotPreview_Init_Statics::PropPointers), sizeof(Z_Construct_UFunction_USlotPreview_Init_Statics::SlotPreview_eventInit_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USlotPreview_Init_Statics::Function_MetaDataParams), Z_Construct_UFunction_USlotPreview_Init_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_USlotPreview_Init_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_USlotPreview_Init_Statics::SlotPreview_eventInit_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USlotPreview_RefreshSlot_Statics::NewProp_InSlotStruct = { "InSlotStruct", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SlotPreview_eventRefreshSlot_Parms, InSlotStruct), Z_Construct_UScriptStruct_FSlotStruct, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USlotPreview_RefreshSlot_Statics::NewProp_InSlotStruct_MetaData), Z_Construct_UFunction_USlotPreview_RefreshSlot_Statics::NewProp_InSlotStruct_MetaData) }; // 3392258304
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USlotPreview_RefreshSlot_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USlotPreview, nullptr, "RefreshSlot", nullptr, nullptr, Z_Construct_UFunction_USlotPreview_RefreshSlot_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USlotPreview_RefreshSlot_Statics::PropPointers), sizeof(Z_Construct_UFunction_USlotPreview_RefreshSlot_Statics::SlotPreview_eventRefreshSlot_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USlotPreview_RefreshSlot_Statics::Function_MetaDataParams), Z_Construct_UFunction_USlotPreview_RefreshSlot_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_USlotPreview_RefreshSlot_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_USlotPreview_RefreshSlot_Statics::SlotPreview_eventRefreshSlot_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USlotPreview_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_USlotPreview_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USlotPreview_Init, "Init" }, // 699410353
		{ &Z_Construct_UFunction_USlotPreview_RefreshSlot, "RefreshSlot" }, // 1238698501
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USlotPreview_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USlotPreview_Statics::NewProp_SlotStruct = { "SlotStruct", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USlotPreview, SlotStruct), Z_Construct_UScriptStruct_FSlotStruct, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USlotPreview_Statics::NewProp_SlotStruct_MetaData), Z_Construct_UClass_USlotPreview_Statics::NewProp_SlotStruct_MetaData) }; // 3392258304
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_USlotPreview_Statics::NewProp_TXTQuantity = { "TXTQuantity", nullptr, (EPropertyFlags)0x001000000008001c, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USlotPreview, TXTQuantity), Z_Construct_UClass_UTextBlock_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USlotPreview_Statics::NewProp_TXTQuantity_MetaData), Z_Construct_UClass_USlotPreview_Statics::NewProp_TXTQuantity_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_USlotPreview_Statics::NewProp_IMGIcon = { "IMGIcon", nullptr, (EPropertyFlags)0x001000000008001c, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USlotPreview, IMGIcon), Z_Construct_UClass_UImage_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USlotPreview_Statics::NewProp_IMGIcon_MetaData), Z_Construct_UClass_USlotPreview_Statics::NewProp_IMGIcon_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USlotPreview_Statics::ClassParams = {
		...
		0,
		0x00B010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USlotPreview_Statics::Class_MetaDataParams), Z_Construct_UClass_USlotPreview_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USlotPreview_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Projects_Automafarm_Source_Automafarm_Public_UI_SlotPreview_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_Automafarm_Source_Automafarm_Public_UI_SlotPreview_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USlotPreview, USlotPreview::StaticClass, TEXT("USlotPreview"), &Z_Registration_Info_UClass_USlotPreview, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USlotPreview), 567534341U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_Automafarm_Source_Automafarm_Public_UI_SlotPreview_h_1299958563(TEXT("/Script/Automafarm"),
		Z_CompiledInDeferFile_FID_Projects_Automafarm_Source_Automafarm_Public_UI_SlotPreview_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projects_Automafarm_Source_Automafarm_Public_UI_SlotPreview_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
